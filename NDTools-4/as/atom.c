...
#if defined(I860)
  header.cputype = CPU_TYPE_I860;
  header.cpusubtype = CPU_SUBTYPE_BIG_ENDIAN;
#else
  header.cputype = CPU_TYPE_MC68030;
  header.cpusubtype = CPU_SUBTYPE_NeXT;
#endif
...
#if defined(I860)
  text_section.align = 5;	/* 2 ^ 5 bytes, or 256 bits (needed for dirbase ops)*/
#else
...
#if defined(I860)
  data_section.align = 4;	/* 2 ^ 4 bytes, or 128 bits */
#else
...
#if defined(I860)
  bss_section.align = 4;	/* 2 ^ 4 bytes, or 128 bits */
#else
  bss_section.align = 2;
#endif
