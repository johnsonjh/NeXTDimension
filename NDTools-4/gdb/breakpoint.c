...
insert_breakpoints ()
{
  ...
  fprintf (stderr, "Inserting breakpoints.\n");
  ...
  ALL_BREAKPOINTS (b)
	...
	if (val)
	  return val;
#ifdef BREAKPOINT_DEBUG
	fprintf (stderr, "Inserted breakpoint at 0x%x, shadow 0x%x, 0x%x.\n",
...
remove_breakpoints ()
{
...
#ifdef BREAKPOINT_DEBUG
  fprintf (stderr, "Removing breakpoints.\n");
#endif /* BREAKPOINT_DEBUG */
  ...
  ALL_BREAKPOINTS (b)
	...
	b->inserted = 0;
#ifdef BREAKPOINT_DEBUG
	fprintf (stderr, "Removed breakpoint at 0x%x, shadow 0x%x, 0x%x.\n",
		b->address, b->shadow_contents[0], b->shadow_contents[1]);
#endif /* BREAKPOINT_DEBUG */
      }
