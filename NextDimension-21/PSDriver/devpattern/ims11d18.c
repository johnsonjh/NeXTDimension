...
Jim Sandman: Wed May 31 16:52:34 1989
Joe Pasqua: Tue Feb 28 11:38:03 1989
End Edit History.
*/

#define SMASK (SCANMASK >> 3)
#define SSHIFT (SCANSHIFT - 3)
#define SUNIT (SCANUNIT >> 3)
#define LOG2BPP 3

#define PROCNAME  ImS11D18

#define DECLAREVARS

#define SETUPPARAMS(args) \
  if (args->bitsPerPixel != 8) RAISE(ecLimitCheck, (char *)NIL);
