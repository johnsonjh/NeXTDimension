...
Paul Rovner: Fri Dec 29 11:10:59 1989
Jim Sandman: Wed Aug  2 10:45:58 1989
Bill Bilodeau Wed Apr  4 16:45:30 PDT 1990
End Edit History.
*/
...
public procedure Im114(items, t, run, args)
  integer items;
  DevTrap *t;
  DevRun *run;
  ImageArgs *args; 
 ...
 register unsigned char *sLoc, *screenElt, *eScrnRow;
  ...
  integer srcMask;
   ...
   if (args->bitsPerPixel != 1 ||
     args->gray.first != 1 || args->gray.n != 2 ||
